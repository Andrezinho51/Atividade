...
class Main {
    public static function run(): void {
        ...
        $filePath = 'C:\Users\Andre\Desktop\Galo_Scrapper\assets\PlanilhaFinal.xlsx';
        ...
        foreach ($data[0] as $trabalho) {
            ...
            for ($i = 0; $i < count($autores); $i += 2) {
                ...
                $Autores_e_Instituicoes[] = $autor;
                $Autores_e_Instituicoes[] = $instituicao;
            }

            // Adicionando uma linha com os dados do trabalho atual
            $rowData = array_merge([$id, $titulo, $tipo], $Autores_e_Instituicoes);
